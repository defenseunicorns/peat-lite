//! OTA (Over-The-Air) firmware update receiver for Peat-Lite.
//!
//! Implements a state machine that receives firmware images from a Peat Full node
